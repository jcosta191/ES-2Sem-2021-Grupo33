...
public class App {
	...
	/*	EscritorJTable a = new EscritorJTable();
		...
		Regras godor = new Regras("God Class or",10,0,50,0,0,0);
		Regras godand = new Regras("God Class and",10,0,50,0,0,1);
		Regras longMor = new Regras("Long Method or",0,0,0,50,10,0);
